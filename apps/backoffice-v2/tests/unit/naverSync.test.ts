  ...
  it('projects eligible orders into purchases using the same canonical mapping path as upload', () => {
    ...
    const orderInfo: NaverOrderInfo = {
      ...
      productOrder: {
        ...
        productOrderStatus: 'PAYED',
        claimStatus: '',
        totalPaymentAmount: 21900,
        orderDiscountAmount: 1000,
        deliveryFeeAmount: 3000,
        deliveryDiscountAmount: 0,
        expectedSettlementAmount: 17300,
        paymentCommission: 1400,
        saleCommission: 2200,
        quantity: 1,
        shippingAddress: {
          name: '김집사',
    ...
    expect(resolved.purchase).toMatchObject({
      ...
      source_channel: 'naver',
      source_fulfillment_type: 'default',
      payment_amount: 21900,
      order_discount_amount: 1000,
      delivery_fee_amount: 3000,
      expected_settlement_amount: 17300,
      payment_commission: 1400,
      sale_commission: 2200,
      quantity: 1,
