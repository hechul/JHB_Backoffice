...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"JHBioFarm SmartStore Analytics & Filter"}],"link":[{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.9/dist/web/variable/pretendardvariable-dynamic-subset.min.css"}],"style":[],"script":[],"noscript":[],"title":"JHBioFarm 백오피스"};
